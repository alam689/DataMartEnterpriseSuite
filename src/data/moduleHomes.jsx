...
export const moduleHomes = {
  ...
  procurement: {
    ...
    functions: [
      ...
      { name: 'Purchase Returns', desc: 'Debit notes & return to vendor.', icon: Undo2, accent: '#c9743f', count: '2 drafts' },
      { name: 'Supplier Management', desc: 'Vendor master, ratings & terms.', icon: Building, accent: '#5ba3c2', count: '186 vendors' },
      { name: 'Procurement Reports', desc: 'Spend analysis & PO ageing.', icon: BarChart3, accent: '#6aa36a', count: '24 reports' },
    ],
    queue: {
